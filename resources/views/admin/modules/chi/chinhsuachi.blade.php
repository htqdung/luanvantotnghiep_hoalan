                ...
                <div class="widget-body" style="background-color: #f7fbff;">
                  <div class="widget-main">
                    <div>
                      ...
                      <input type="text"  name="ten_chi"  class="form-control" id="chi"  value="{{ $data[0]->ten_chi }}" placeholder="Điền tên chi">
                    </div>
                    <br>
                    <div>
                    ...
                    <div class=" form-group" style="padding-top: 20px" >
                        ...
                        <textarea style="height: 500px" rows="20" id="content" > {{ $data[0]->mo_ta }}</textarea>
