...
<a href="{{ route('MO_GIAO_DIEN_ADMIN') }}">Trang chủ</a>
   ...
   <div class="box-header with-border">
          <a style="float: right; padding: 0px; margin-left: 5px" class="btn btn-warning" href="{{ route('DANH_SACH_NGUOI_DUNG') }}"><i class=""></i>Quay lại</a>
											...
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span>{{ $nguoidung[0]->so_dien_thoai }}</span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span>{{ $nguoidung[0]->so_nha}}, {{ $nguoidung[0]->ten_duong }}, {{ $nguoidung[0]->ten_phuong_xa }}, {{ $nguoidung[0]->ten_quan_huyen}} , {{ $nguoidung[0]->ten_tinh_thanhpho }}</span>
													</div>
												</div>
