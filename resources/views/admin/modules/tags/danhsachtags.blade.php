    ...
    <ul class="breadcrumb">
      <li>
        <i class="ace-icon fa fa-home home-icon"></i>
            <a href="{{ route('MO_GIAO_DIEN_ADMIN') }}">Trang chủ>></a><a href="javascript:void(0)">Danh sách tags</a>
      </li>
    ...
    <div class="col-xs-12">
      ...
      <div class="widget-box">
        <div class="widget-header widget-header-blue widget-header-flat" style="text-align: center;">
          <h4 class="widget-title lighter" >DANH SÁCH TAGS</h4>
          {{-- <div class="widget-toolbar">
            <button class="btn btn-white btn-info btn-bold"  ><i class="ace-icon fa fa-plus bigger-120 blue"></i> <a href="{{ route('THEM_TAGS') }}">Thêm mới</a>  </button>
          </div> --}}
        </div>
      </div>
      <div class="hr hr-18 hr-double dotted"></div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-danger" href="{{ route('XOA_TAGS', $item->id) }}" id="remove-button" type="submit">Đồng ý</a>
                        </div>
