...
<html lang="en">
	...
	messages: {
		...
		old_pass: "Vui lòng nhập số điện thoại liên hệ",
										...
										<div class="widget-main">
											...
											<form class="form-horizontal" role="form" method="POST" id="doimatkhau" action="" >
												...
												<fieldset >
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" name="new_pass"  class="form-control" placeholder="Mật khẩu mới">
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</label>
													<label class="block clearfix">
													...
													<div class="clearfix">
														...
														<button type="submit" class="width-40 pull-right btn btn-sm btn-primary" id="submit_change">
															<i class="glyphicon glyphicon-ok"></i>
															<span class="bigger-110">Lưu thay đổi</span>
														</button>
													</div>
