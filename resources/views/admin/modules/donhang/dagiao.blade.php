...
<div class="main-content-inner">
  <div class="breadcrumbs ace-save-state" id="breadcrumbs">
    <ul class="breadcrumb">
      ...
      <li><a href="javascript:void(0)">Đơn hàng đã giao</a></li>
    </ul><!-- /.breadcrumb -->
                ...
                @foreach ($data as $item)
                  <tr>
                   ...
                   <td>
                        ...
                        <a style=" margin: 0px; padding: 0px; width: 40px" class="btn btn-warning" data-toggle="tooltip" title="Chi tiết"  href="{{ route('CHI_TIET_DA_GIAO') }}"><i class="glyphicon glyphicon-folder-open"></i></a>
