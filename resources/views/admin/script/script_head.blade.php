<head>
    ...
    <link rel="stylesheet" href=" {{ asset('admin/assets/tagsinput/bootstrap-tagsinput.css') }} ">
    <link rel="stylesheet" href=" {{ asset('admin/assets/tagsinput/bootstrap-tagsinput.js') }} ">
    <link rel="stylesheet" href=" {{ asset('admin/assets/tagsinput/bootstrap-tagsinput-angular.js') }} ">
