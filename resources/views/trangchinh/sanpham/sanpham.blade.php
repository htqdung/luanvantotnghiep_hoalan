						...
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Ethnic Wear</label>
								<ul>
									...
									<li><a href="trangchinh/sanpham/sanpham">Caps</a></li>
									...
									<li><a href="trangchinh/sanpham/sanpham">Trousers</a></li>
								</ul>
							</li>
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						...
						<li>
							<img class="img-responsive" src="trangchinh_asset/images/banner5.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="trangchinh_asset/images/banner2.jpg" alt=" "/>
						</li>
