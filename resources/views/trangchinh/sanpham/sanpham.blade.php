						...
						<div class="shop-side-bar">
                                ...
                                <div class="checkbox checkbox-primary">
                                    <ul>
                                        ...
                                        <li class="{{ Request::segment(2) == str_slug($sp->ten_loai).'-'.$sp->id.'.html' ? 'active' : ''  }}" >
                                            <a href="{{ route('loaisp',[str_slug($sp->ten_loai),$sp->id]) }}">{{ $sp->ten_loai }}</a>
                                        </li>
                                        @endforeach
                            ...
                            <div>
                                ...
                                <div class="checkbox checkbox-primary">
                                    <ul>
                                        <li class="{{ Request::segment(2) == str_slug($sp->ten_hinh_thuc).'-'.$sp->id.'.html' ? 'active' : ''  }}" >
                                            <a href="{{ \App\Helpers\Url::addParams(['quatang' => 'sp->-2']) }}">{{ "Quà tặng" }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
							...
							<div class="checkbox checkbox-primary">
                                <ul>
                                    <li class="<?= \Request::get('price') == '<1' ? 'active' : '' ?>">
                                        <a href="<?= \App\Helpers\Url::addParams(['price' => '<1']) ?>"> Thấp hơn 1tr đồng   </a>
                                    </li>
					...
					<div class="col-md-9">
						...
						<div class="item-col-4">
							...
							@foreach($products as $pro)
								<div class="product">
									<article> <img style="height: 250px" class="img-responsive" src="{{ asset('trangchinh_asset/images') }}/{{ $pro->ten_hinh }}" alt="" >
										<!-- Content -->
