  	...
  	<div class="container">
  		...
  		<div class="col-md-8 single-right-left simpleCart_shelfItem">
  			...
  			<div class="description">
  				<h5>Kiểm tra vận chuyển, phương thức thanh toán và chi phí tại địa chỉ của bạn</h5>
  				<form action="#" method="post">
  					<input type="text" value="Nhập địa chỉ" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nhập địa chỉ';}" required="">
